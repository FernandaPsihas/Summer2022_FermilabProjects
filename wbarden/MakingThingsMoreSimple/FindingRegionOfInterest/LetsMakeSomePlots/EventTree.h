...
// Wed Jul  6 14:59:51 2022 by ROOT version 6.22/08
// from TTree EventTree/tree
// found on file: ../monoenergetic_2.5MeV_electrons_undoped.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../monoenergetic_2.5MeV_electrons_undoped.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../monoenergetic_2.5MeV_electrons_undoped.root");
      }
